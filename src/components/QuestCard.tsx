...
export function QuestCard({ quest }: Props) {
  ...
  return (
    <div className="relative w-full max-w-xs">
      <div
        className={`absolute inset-0 rounded-md ${glowColor} border-2 border-black`}
      />

      <Card
        className="relative z-10 w-full rounded-md border-2 border-black p-0 overflow-hidden
        transition-transform hover:-translate-x-1.5 hover:-translate-y-1.5 font-extrabold"
      >
        ...
        <CardContent className="px-4 pb-4">
          ...
          <div className="text-md mb-5 truncate">{quest.description}</div>
